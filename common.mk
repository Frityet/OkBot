...
CPPFLAGS=-D_POSIX_THREADS -D_UNIX98_THREAD_MUTEX_ATTRIBUTES -D_POSIX_TIMERS -D_POSIX_MONOTONIC_CLOCK -fcoroutines
...
INCLUDE=$(foreach dir,$(INCDIR) $(EXTRA_INCDIR),-isystem"$(dir)")
